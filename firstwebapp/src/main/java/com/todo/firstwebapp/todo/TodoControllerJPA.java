...
public class TodoControllerJPA {
	...
	//to autowire
	public TodoControllerJPA(TodoRepo repo) {
		super();
	...
	public String listAll(ModelMap model){
		...
		List<Todo> todos = repo.findByUsername(getLoggerUser()); //important to name it as findbyusername as the field is username
	...
	//this will be removed when server restarts model.map is ephemeral
...
//	}
	...
	public String addnewTodo(ModelMap model, @Valid Todo todo, BindingResult result ){ //todo needs to be valid before moving further
		...
		repo.save(todo);//save to database
